...
import { createOfficer, listOfficers, updateOfficer, deleteOfficer, dashboard, seedDemoData, seedOfficers, getFastestSolvers, getTimerDuration, setTimerDuration, deleteAllUsers, deleteUser, updateOtp, logoutAllUsers } from "../controllers/adminController.js";
...
router.post("/otp", requireAdmin, updateOtp);
router.post("/logout-all", requireAdmin, logoutAllUsers);
